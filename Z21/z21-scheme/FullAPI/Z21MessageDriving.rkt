...
(provide make-get-loco-info-msg
         make-set-loco-drive-msg
         
         low-speed-range
         med-speed-range
         high-speed-range

         make-set-loco-function-msg
         is-loco-info-msg?
         get-loco-info-address
         loco-info-busy?
         get-loco-info-forward?
         get-loco-info-speed
         get-loco-info-speed-range
         loco-info-doppeltraction?
         loco-info-smartsearch?
         loco-info-func-on?
         func-off
         func-once
         func-switch 
